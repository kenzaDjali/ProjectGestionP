	...
	<div class="contenu">
		<form class="form-horizontal" action="" method="POST">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="last_name" name="last_name" type="text"
							placeholder="Entrez le nom" class="input-xlarge" required="">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="first_name" name="first_name" type="text"
							placeholder="Entre le prénom" class="input-xlarge" required="">
					</div>
				</div>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="email" name="email" type="text"
							placeholder="Entrez l'e-mail" class="input-xlarge" required="">
					</div>
				</div>
				...
				<!-- Text input-->
				<div class="control-group">
					<label class="control-label" for="cell_phone_number">Numéro de
				...
				<div class="control-group">
					...
					<div class="controls">
						<input id="phone_number" name="phone_number" type="text"
							placeholder="Entre un numéro de téléphone fixe"
							class="input-xlarge">
					</div>
				</div>
				...
				<div class="control-group double">
					...
					<div class="controls">
						<button id="submit" name="submit" class="btn btn-success"
							value="register">Enregistrer l'apprenant</button>
						<button id="reset" name="reset" class="btn btn-danger"
